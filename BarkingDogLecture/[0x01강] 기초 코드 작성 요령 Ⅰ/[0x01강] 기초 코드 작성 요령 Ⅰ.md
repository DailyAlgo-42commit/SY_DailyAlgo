...
- 시간복잡도
    ...
    ![image.png]([0x01강] 기초 코드 작성 요령 Ⅰ/image.png)
    ...
    ![image.png]([0x01강] 기초 코드 작성 요령 Ⅰ/image 1.png)
    
    ![image.png]([0x01강] 기초 코드 작성 요령 Ⅰ/image 2.png)
    
    ![image.png]([0x01강] 기초 코드 작성 요령 Ⅰ/image 3.png)
    
    시간복잡도 ⇒ 빅오표기법의 형태로 나타냄
    
    ![image.png]([0x01강] 기초 코드 작성 요령 Ⅰ/image 4.png)
    
    ![image.png]([0x01강] 기초 코드 작성 요령 Ⅰ/image 5.png)
    
    ![image.png]([0x01강] 기초 코드 작성 요령 Ⅰ/image 6.png)
    ...
    ![image.png]([0x01강] 기초 코드 작성 요령 Ⅰ/image 7.png)
    ...
    ![image.png]([0x01강] 기초 코드 작성 요령 Ⅰ/image 8.png)
    ...
    ![image.png]([0x01강] 기초 코드 작성 요령 Ⅰ/image 9.png)
...
- 공간복잡도
    ...
    ![image.png]([0x01강] 기초 코드 작성 요령 Ⅰ/image 10.png)
    

### 0x01 정수 자료형

![image.png]([0x01강] 기초 코드 작성 요령 Ⅰ/image 11.png)

![image.png]([0x01강] 기초 코드 작성 요령 Ⅰ/image 12.png)

![image.png]([0x01강] 기초 코드 작성 요령 Ⅰ/image 13.png)

int가 longlong 보다 연산 속도와 메모리 모두 우수하지만, 80번째 피보나치 수를 구하는 문제와 같이 int 자료형이 표현할 수 있는 범위를 넘어서는 수를 저장해야 하면 반드시 **longlong** 자료형 사용. 

![image.png]([0x01강] 기초 코드 작성 요령 Ⅰ/image 14.png)

![2진수, 10진수 모두 제대로 계산됨]([0x01강] 기초 코드 작성 요령 Ⅰ/image 15.png)

2진수, 10진수 모두 제대로 계산됨

![2진수, 10진수 모두 제대로 계산됨]([0x01강] 기초 코드 작성 요령 Ⅰ/image 16.png)

2진수, 10진수 모두 제대로 계산됨

![01111111 + 1 = 10000000
 $-2^7$의 칸 ⇒ 10000000 = -128 
127+1 = -128 ⇒ Integer Overflow]([0x01강] 기초 코드 작성 요령 Ⅰ/image 17.png)

01111111 + 1 = 10000000
 $-2^7$의 칸 ⇒ 10000000 = -128 
127+1 = -128 ⇒ Integer Overflow

![image.png]([0x01강] 기초 코드 작성 요령 Ⅰ/image 18.png)
...
![image.png]([0x01강] 기초 코드 작성 요령 Ⅰ/image 19.png)

![image.png]([0x01강] 기초 코드 작성 요령 Ⅰ/image 20.png)
...
![image.png]([0x01강] 기초 코드 작성 요령 Ⅰ/image 21.png)

이렇게 실수를 저장하는 방식 : IEEE-754 format

### 실수의 성질

![image.png]([0x01강] 기초 코드 작성 요령 Ⅰ/image 22.png)
...
![image.png]([0x01강] 기초 코드 작성 요령 Ⅰ/image 23.png)
...
![image.png]([0x01강] 기초 코드 작성 요령 Ⅰ/image 24.png)
